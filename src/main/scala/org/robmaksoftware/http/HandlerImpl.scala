...
class HandlerImpl[F[_]: Monad](
  ...
  override def getAllPeople(
      respond: HttpResource.GetAllPeopleResponse.type
  )(offset: Option[Int], limit: Option[Int]): F[HttpResource.GetAllPeopleResponse] = {
  ...
  override def deletePerson(
      respond: HttpResource.DeletePersonResponse.type
  )(personId: PersonId): F[HttpResource.DeletePersonResponse] = {
  ...
  override def updatePerson(
      respond: Resource.UpdatePersonResponse.type
  )(personId: PersonId, body: PersonDto): F[Resource.UpdatePersonResponse] = {
  ...
  override def createPerson(
      respond: HttpResource.CreatePersonResponse.type
  )(body: PersonDto): F[HttpResource.CreatePersonResponse] = {
